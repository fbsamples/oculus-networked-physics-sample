...
static class BinaryWriterExtensions
{
    public static void Write(this BinaryWriter writer, OvrAvatarDriver.PoseFrame frame)
    {
        ...
        writer.Write(frame.handLeftPose);
        writer.Write(frame.handRightPose);
    }
    ...
    {
        writer.Write(pose.button1IsDown);
        writer.Write(pose.button2IsDown);
        writer.Write(pose.joystickPosition);
        writer.Write(pose.indexTrigger);
        writer.Write(pose.gripTrigger);
    }

    public static void Write(this BinaryWriter writer, OvrAvatarDriver.HandPose pose)
    {
        writer.Write(pose.indexFlex);
        writer.Write(pose.gripFlex);
        writer.Write(pose.isPointing);
        writer.Write(pose.isThumbUp);
    }
}
...
static class BinaryreaderExtensions
{
    public static OvrAvatarDriver.PoseFrame ReadPoseFrame(this BinaryReader reader)
    {
        return new OvrAvatarDriver.PoseFrame
        {
            ...
            handLeftPose = reader.ReadHandPose(),
            handRightPose = reader.ReadHandPose()
        };
    }
    ...
    public static OvrAvatarDriver.ControllerPose ReadControllerPose(this BinaryReader reader)
    {
        ...
        {
            button1IsDown = reader.ReadBoolean(),
            button2IsDown = reader.ReadBoolean(),
            joystickPosition = reader.ReadVector2(),
            indexTrigger = reader.ReadSingle(),
            gripTrigger = reader.ReadSingle(),
        };
    }

    public static OvrAvatarDriver.HandPose ReadHandPose(this BinaryReader reader)
    {
        return new OvrAvatarDriver.HandPose
        {
            indexFlex = reader.ReadSingle(),
            gripFlex = reader.ReadSingle(),
            isPointing = reader.ReadBoolean(),
            isThumbUp = reader.ReadBoolean()
        };
    }
}